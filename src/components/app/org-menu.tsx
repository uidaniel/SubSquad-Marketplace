...
export function OrgMenu({
  ...
  return (
    <DropdownMenu.Root>
      ...
      >
        <span className="grid size-8 shrink-0 place-items-center rounded-full bg-info text-[12px] font-semibold text-white lg:size-7 lg:text-[12px]">
          {initials}
        </span>
      ...
      <DropdownMenu.Portal>
        ...
        >
          <DropdownMenu.Label className="px-2.5 py-2 text-[12px] font-medium uppercase tracking-wide text-ink-3">
            {orgName}
          </DropdownMenu.Label>
